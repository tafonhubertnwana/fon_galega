...
import fonImg from "@/public/fon/HistoryImg.jpg"; // Replace with your image path

export default function FonHistory() {
  return (
    <section className="container xl:max-w-6xl mx-auto text-center">
      <div className="grid grid-cols-1 md:grid-cols-2 px-4 py-6 items-stretch bg-white">
        {/* Left Side */}
        <motion.div
        ...
        >
          <h2 className="text-4xl font-bold mb-4">FON GALEGA II</h2>
